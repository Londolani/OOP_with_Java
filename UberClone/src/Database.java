...
public class Database {
    ...
    public void getDriversArray() {
        try {
            BufferedReader csvReader = new BufferedReader(new FileReader("drivers.csv")); //ability to read from a file
            String row = null;
            int i = 0;
            ...
            System.out.println("Error: " + e.toString()); //able to demostrate use of print statement to get where stuck
        }
    }
